...
# ====================================================================
results <- readRDS("./article/Bixi/data/final_results/BKTR_results_final_25pct.rds")


#=====================================================================
results2 <- readRDS("./article/Bixi/data/final_results/IMR_results_final_25pct.rds") %>%
...
readRDS("./article/Bixi/data/final_results/IMR_results_final_25pct.rds") %>%
  filter(metric == "RMSE") %>%
  select(test, model, prefix, lambda_nuclear, rank_M, train_size) %>%
