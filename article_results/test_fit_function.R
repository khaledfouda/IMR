...
cv_out_b <- imr_tune_lasso(data, grid, "beta", intercept_row = FALSE, intercept_col = FALSE,
                           shared_beta = FALSE, shared_gamma = FALSE,
                           final_fit = TRUE, convergence=convergence, verbose=3, seed=2025)

cv_out_g <- imr_tune_lasso(data, grid, "gamma", intercept_row = FALSE, intercept_col = FALSE,
                         shared_beta = FALSE, shared_gamma = FALSE,
